/* Trajectory chart — animated SVG line/area with milestone tooltips */
...
function TrajectoryChart({ lang }) {
  const C = window.CONTENT.trajectory;
  ...
  useEffect(() => {
    return window.observeReveal
      ? window.observeReveal(ref.current, () => setDrawn(true))
      : (setDrawn(true), undefined);
  }, []);
